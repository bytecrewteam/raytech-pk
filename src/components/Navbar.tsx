          ...
          <div className="lg:hidden border-t border-border bg-background animate-fade-in-up">
            <div className="container mx-auto px-4 py-4 space-y-3">
              ...
              <div className="flex gap-2 pt-2 border-t border-border">
                <Link to="/wishlist" className="flex items-center gap-2 py-2 text-sm text-muted-foreground hover:text-foreground" onClick={() => setMobileMenuOpen(false)}>
                  <Heart className="w-4 h-4" /> Wishlist
                </Link>
                <Link to="/account" className="flex items-center gap-2 py-2 text-sm text-muted-foreground hover:text-foreground ml-4" onClick={() => setMobileMenuOpen(false)}>
